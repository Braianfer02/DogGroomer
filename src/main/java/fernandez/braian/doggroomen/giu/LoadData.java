...
public class LoadData extends javax.swing.JFrame {
    ...
    ControllerLogic Controller = new ControllerLogic();
    int xMouse, yMouse;
    ...
    private void initComponents() {
        ...
        btnClear.setFont(new java.awt.Font("Rockwell", 1, 20)); // NOI18N
        btnClear.setForeground(new java.awt.Color(255, 255, 255));
        btnClear.setIcon(new javax.swing.ImageIcon("C:\\Users\\Braia\\OneDrive\\Documentos\\Programing Proyect\\Java\\DogGroomen\\src\\main\\resources\\images\\Icon\\Delete.png")); // NOI18N
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        Controller.saveDogs(
                ...
                txtRace.getText(), 
                txtColor.getText(), 
                jcbAllergic.getSelectedItem(), 
                jcbSpecialAttention.getSelectedItem(), 
        ...
        // Successful window
        JOptionPane optionPane = new JOptionPane("was saved successfully");
